      ...
      <Grid>
        ...
        <Cell className="about-right" col={8}>
          ...
          <div className="about-me">
            <p>
              Ancien technicien de maintenance adepte des technologies de
              régulation et de fonctionnement des systèmes de climatisations et
              d'électricité , passionné par le monde du numérique j'ai décidé de
              me lancer dans une reconversion professionnelle en tant que
              développeur web FullStack Js au sein de la Wild Code School.
            </p>
          </div>
          ...
          <Education
            ...
            description={
              "HTML / CSS, JavaScript, React, NodeJs, mySql, Express, Méthodes agiles (scrum), Git, Github"
            }
          />
